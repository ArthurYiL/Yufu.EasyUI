...
namespace EasyUI.NET
{
  public static class DictionaryExtensions
  {
    ...
    public static void Merge(this IDictionary<string, object> instance, string key, int value)
    {
      Merge(instance, key, value, true);
    }

    public static void Merge(this IDictionary<string, object> instance, string key, bool value)
    {
      Merge(instance, key, value, true);
    }

    public static void Merge(this IDictionary<string, object> instance, string key, string value)
    {
      Merge(instance, key, value, true);
    }
